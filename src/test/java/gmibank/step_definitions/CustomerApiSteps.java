...
Response response;
Customer9 actualData=new Customer9();
...
Customer9[] customers;
    ...
    public void user_uses_api_end_point_to_get_all_customer_data(String url) {
       ...
       // response.prettyPrint();
        ...
        actualData = response.as(Customer9.class);

        System.out.println(actualData.getId());

       List<Customer9> list = Arrays.asList(actualData);
...
//        System.out.println(actualData);
        ...
        Assert.assertTrue("not found",validates.contains("Della"));
//                Assert.assertTrue(response.getStatusCode() == 200);
//                Assert.assertTrue(actualData.getFirstName().equals(actualData.getState()));
